...
export const AddGoalForm: React.FC<AddGoalFormProps> = ({ onAddRequest, onCancel }) => {
  ...
  return (
    <motion.form 
      ...
      className="bg-white p-4 sm:p-5 rounded-3xl shadow-sm border-2 border-amber-200 overflow-hidden"
    >
      <h3 className="font-black text-base sm:text-lg text-amber-700 mb-3">Set a New Goal 🎯</h3>
      ...
      <div className="flex flex-col sm:flex-row gap-2">
        <button type="submit" className="w-full sm:flex-1 bg-amber-500 hover:bg-amber-600 text-white font-bold py-3 rounded-xl transition-colors">Save Goal</button>
